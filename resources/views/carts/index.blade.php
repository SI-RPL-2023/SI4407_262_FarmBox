                                                ...
                                                <tr
                                                    ...
                                                    <td class="w-4 p-4">
                                                        <div class="flex items-center">
                                                            ...
                                                            <label for="product_ids" class="sr-only">checkbox</label>
                                                        </div>
                                                    </td>
                                                    <th scope="row"
                        ...
                        <section class="container mx-auto h-screen mt-10">
                            <div class="grid grid-cols-1 md:grid-cols-2">
                                ...
                                <div class="sm:w-3/3 w-full">
                                    <div class="bg-white p-6 border border-gray-200 rounded-lg shadow-md w-full h-full">
                                        <div class="divide-y divide-gray-900">
                                            <div class="mb-6">
                                                ...
                                                <div class="flex justify-between mt-3">
                                                    <h1 class="text-bold text-lg sm:text-lg text-gray-500 font-medium">
                                                        Subtotal</h1>
                                                    <h1 class="text-bold text-lg sm:text-lg  text-gray-500 font-medium">
                                                        @currency($totalPrice)
                                                    </h1>
                                                ...
                                                <div class="flex justify-between mt-3">
                                                    <h1 class="text-bold text-lg sm:text-lg text-gray-500 font-medium">
                                                        Discount 10%</h1>
                                                    <h1 class="text-bold text-lg sm:text-lg text-red-500 font-medium">
