                                ...
                                <div class="lg:flex lg:-mx-2">
                                    ...
                                    <div class="mt-6 lg:mt-0 lg:px-2 lg:w-3/5">
                                        ...
                                        <div class="flex mt-2.5 items-center gap-3">
                                            ...
                                            <div>
                                                <p class="text-red-700">({{ $reviews->count() }}) Review</p>
                                            </div>
                                        </div>
                        ...
                        @foreach ($reviews as $review)
                            <div class="flex border w-full">
                                <div class="flex items-center h-full">
                                    <img class="py-4 px-2" src="{{ asset('storage/' . $product->image) }}"
                                        alt="image description">
                                </div>
                                <div>
                                    ...
                                    <div class="flex items-start mt-2.5 justify-start">
                                    ...
                                    <p>{{ $review->commentar }}</p>
                                </div>
                            </div>
                        @endforeach
                        <a href={{ route('review.index', $product) }}>Add Review</a>
                    </div>
                </div>
            </div>
        </div>
